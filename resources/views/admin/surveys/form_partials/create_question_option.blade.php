<div class="col-12 mt-2 option-box">
    <div class="input-group">
            <span class="d-inline-flex pe-2 sortable-handle">
                <i class="@if(!($option->is_checkbox ?? false)) d-none @endif option-visible-element visible-{{\App\Enums\SurveyQuestionTypeEnum::MULTI_LIST}} bx bx-checkbox fs-4 mt-2"></i>
                <i class="@if(!($option->is_radio ?? false)) d-none @endif option-visible-element visible-{{\App\Enums\SurveyQuestionTypeEnum::ONCE_LIST}} bx bx-radio-circle fs-4 mt-2"></i>
                <i class="@if(!($option->is_select ?? false)) d-none @endif option-visible-element visible-{{\App\Enums\SurveyQuestionTypeEnum::SELECT}} bx bx-list-ul fs-4 mt-2"></i>
            </span>
