...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('user_groups')->insert([
            ['name' => 'Administrator', 'description' => 'Administrator', 'is_admin' => true],
            ['name' => 'Edytor', 'description' => 'Osoba upoważniona do edycji ankiet', 'is_admin' => false],
            ['name' => 'Analityk danych', 'description' => 'Osoba która może przeglądac wyniki z ankiet', 'is_admin' => false],
        ]);
